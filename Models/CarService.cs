...
namespace GarasiMobil.Services
{
    public class CarService
    {
        ...
        public CarService(IOptions<GarasiMobilDatabaseSettings> garasiMobilSettings)
        {
            var mongoClient = new MongoClient(garasiMobilSettings.Value.ConnectionString);
            var mongoDatabase = mongoClient.GetDatabase(garasiMobilSettings.Value.DatabaseName);
            _carsCollection = mongoDatabase.GetCollection<Car>(garasiMobilSettings.Value.CarsCollectionName);
        }
